...
import { ExpensePDF } from "./pdfs-and-templates";
  ...
  return (
    <>
      <PDFPreviewModal modalOpen={pdfModalOpen} setModalOpen={setPDFModalOpen}>
        <ExpensePDF selectedRecord={selectedRecord} business={business} />
      </PDFPreviewModal>
                  ...
                  {searchCriteria.fromDate && searchCriteria.toDate && (
                    <li>
                      ...
                      <b>
                        ...
                        and{" "}
                        {dayjs(searchCriteria.toDate).format(
                          REPORT_DATE_FORMAT
                        )}
                      </b>
                    </li>
              ...
              <div className="content-column-header-row-actions">
                ...
                <div style={{ borderRight: "1px solid var(--border-color)" }}>
                  ...
                  >
                    <span>
                      <FormattedMessage
                        id="button.expenseHistory"
                        defaultMessage="Expense History"
                      />
                    </span>
                  </Button>
                </div>
