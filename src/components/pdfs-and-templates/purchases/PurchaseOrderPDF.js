...
const PurchaseOrderPDF = ({ selectedRecord, business }) => {
  ...
  const Detail = () => (
    <View style={styles.section1}>
      <View style={[styles.alignBottom, { paddingBottom: 10 }]}>
        <CustomText>
          <CustomText>Deliver To{"\n"}</CustomText>
          <CustomText>{selectedRecord.deliveryAddress}</CustomText>
        </CustomText>
      </View>
      <View style={[styles.contentDetails, styles.alignRight]}>
        ...
        <View style={styles.lineHeight2}>
          <CustomText style={styles.alignRight}>
            ...
            <CustomText>
              {dayjs(selectedRecord?.expectedDeliveryDate).format(
                REPORT_DATE_FORMAT
              )}
              {"\n"}
            </CustomText>
