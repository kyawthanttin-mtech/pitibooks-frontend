...
const SalesOrderPDF = ({ selectedRecord, business }) => {
  ...
  const Title = () => (
    <View style={styles.titleSection}>
      ...
      <CustomText style={styles.alignRight}>
        <CustomText style={styles.header}>SALES ORDER{"\n"}</CustomText>
        <CustomText>
    ...
    <View style={styles.section1}>
      <View style={[styles.alignBottom, { paddingBottom: 10 }]}>
        <CustomText>
          ...
          <CustomText>{selectedRecord?.customer?.address}</CustomText>
        </CustomText>
      </View>
      <View style={[styles.contentDetails, styles.alignRight]}>
        ...
        >
          <CustomText style={styles.alignRight}>
            ...
            {selectedRecord?.expectedShipmentDate && (
              <CustomText>Expected Shipment Date :{"\n"}</CustomText>
            )}
        ...
        <View style={styles.lineHeight2}>
          <CustomText style={styles.alignRight}>
            <CustomText>
              {dayjs(selectedRecord?.orderDate).format(REPORT_DATE_FORMAT)}
              {"\n"}
            </CustomText>
            {selectedRecord?.expectedShipmentDate && (
              <CustomText>
                {dayjs(selectedRecord?.expectedShipmentDate).format(
                  REPORT_DATE_FORMAT
                )}
                {"\n"}
              </CustomText>
            ...
            <CustomText>
              {selectedRecord.orderPaymentTerms.split(/(?=[A-Z])/).join(" ") ===
              "Custom"
