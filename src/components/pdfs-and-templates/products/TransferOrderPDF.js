...
const TransferOrderPDF = ({ selectedRecord, business }) => {
  ...
  const Title = () => (
    <View style={styles.titleSection}>
      ...
      <CustomText style={styles.alignRight}>
        <CustomText style={styles.header}>TRANSFER ORDERS{"\n"}</CustomText>
        <CustomText>
      ...
      <View style={[styles.contentDetails, styles.alignRight]}>
        ...
        >
          <CustomText style={styles.alignRight}>
            ...
            {selectedRecord?.reason && <CustomText>Reason :{"\n"}</CustomText>}

            <CustomText>Source Warehouse :{"\n"}</CustomText>
            <CustomText>Destination Warehouse :{"\n"}</CustomText>
          </CustomText>
        </View>
  ...
  const TableHead = () => (
    <View style={styles.thead} fixed>
      ...
      >
        <CustomText>Transfer Qty</CustomText>
      </View>
    </View>
  );
