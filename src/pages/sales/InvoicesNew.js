...
const InvoicesNew = () => {
  ...
  const [subTotal, setSubTotal] = useState(
    record?.orderSubtotal || record?.invoiceSubtotal || 0
  );
  const [totalTaxAmount, setTotalTaxAmount] = useState(
    record?.orderTotalTaxAmount || record?.invoiceTotalTaxAmount || 0
  );
    ...
    CREATE_INVOICE,
    {
      onCompleted() {
        openSuccessMessage(
          ...
          <FormattedMessage
            id="invoice.created"
            defaultMessage="New Invoice Created"
          />
        );
    ...
    <>
      ...
      <div className="page-header">
        <p className="page-header-text">
          <FormattedMessage id="invoice.new" defaultMessage="New Invoice" />
        </p>
        <Button
          icon={<CloseOutlined />}
          type="text"
